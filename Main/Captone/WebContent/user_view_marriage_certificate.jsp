...
<head>
    ...
    <title>Track Marriage Certificate - Gram Panchayat</title>
    ...
    <style>
        :root {
            --theme-rose: #e11d48;
            --theme-rose-dark: #be123c;
            --theme-rose-light: #fff1f2;
            --bg-body: #f3f4f6;
            --bg-card: #ffffff;
            --text-main: #1f2937;
            --text-muted: #6b7280;
        ...
        * {
        ...
        .icon-circle {
            width: 70px;
            height: 70px;
            background: var(--theme-rose-light);
        ...
        .btn-search:hover {
            background-color: var(--theme-rose-dark);
            color: white;
    ...
    <div class="tracking-card">
        ...
        <form method="GET">
            <div class="input-group-custom">
                ...
                <input type="text" name="searchId" class="form-control" placeholder="Enter App ID (e.g., GP-MAR-...)" 
        ...
        <% 
            ...
            if(searchId != null && !searchId.trim().isEmpty()) {
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT status FROM marriage_applications WHERE application_number=?");
                    ...
                    if(rs.next()) {
                        ...
                        if(isApproved) {
                            ...
                            out.println("<p class='text-muted mt-3 mb-0' style='font-size:0.85rem;'><i class='fas fa-info-circle text-warning'></i> Your certificate is not generated yet. Please wait for Admin approval.</p>");
                        }
                        out.println("</div>");
                        
                        if(isApproved) {
                            out.println("<a href='marriage_certificate.jsp?appId="+searchId+"' target='_blank' class='btn btn-print'>");
                        ...
                        out.println("<p class='text-muted mt-2 mb-0' style='font-size:0.85rem;'>Please check your Application ID and try again.</p>");
                        out.println("</div>");
                    }
                    con.close();
                } catch(Exception e) {
