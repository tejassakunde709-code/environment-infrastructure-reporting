...
<head>
    ...
    <style>
        ...
        .app-id { background: #fce4ec; border: 2px dashed #d81b60; padding: 20px; font-size: 1.8rem; font-weight: bold; color: #d81b60; margin: 20px 0; }
...
<div class="container d-flex justify-content-center">
    <div class="card col-md-8">
        <h2 style="color: #d81b60;">Application Successful!</h2>
        ...
        <div class="mt-4">
            <button onclick="navigator.clipboard.writeText(document.getElementById('appId').innerText); alert('Copied!');" class="btn btn-outline-danger">Copy ID</button>
            <a href="user_view_marriage_certificate.jsp" class="btn btn-danger">Track Status</a>
        </div>
    </div>
</div>
</body>
